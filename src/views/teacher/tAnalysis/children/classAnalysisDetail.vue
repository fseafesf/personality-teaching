<template>
  <div>
    <div class="inputBar">
      <el-input placeholder="请输入要查找的知识点" v-model="keyword"></el-input>
      <el-button type="primary" @click="searchStuFn">搜索</el-button>
...
export default {
  ...
  data() {
    return {
      keyword: "",
      classAnalysisData: [
        { classId: "111111", points: "知识点1", score: 85 },
        { classId: "222222", points: "知识点2", score: 95 },
        { classId: "333333", points: "知识点3", score: 75 },
        { classId: "444444", points: "知识点4", score: 65 },
  ...
  methods: {
    ...
    // 添加数据到班级统计表中
    getClassChartData() {
      this.classAnalysisData.forEach(item => {
        let classData = []
        classData.push(item.score, item.points)
        this.source.push(classData)
      })
    },
    // 班级掌握情况
    classChartFn() {
